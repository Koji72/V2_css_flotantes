...
export class PanelDebugger {
    private static instance: PanelDebugger | null = null;
    ...
    public static getInstance(): PanelDebugger {
    ...
    public async debugPanelRendering(markdown: string): Promise<void> {
