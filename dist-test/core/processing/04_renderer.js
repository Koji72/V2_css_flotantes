...
const hast_util_sanitize_1 = require("hast-util-sanitize"); // Sanitizer
const mdast_util_to_hast_1 = require("mdast-util-to-hast"); // mdast -> hast
const hast_util_to_html_1 = require("hast-util-to-html"); // hast -> HTML string
...
const schema = { ...hast_util_sanitize_1.defaultSchema };
...
schema.attributes['*'].push('dataPanelType', 'dataInteractiveContainer', 'dataPanelTitle', 
...
function renderAstToHtml(ast) {
    ...
    try {
        ...
        const hast = (0, mdast_util_to_hast_1.toHast)(ast, { allowDangerousHtml: true });
        if (!hast) {
        ...
        const sanitizedHast = (0, hast_util_sanitize_1.sanitize)(hast, schema);
        ...
        html = (0, hast_util_to_html_1.toHtml)(sanitizedHast, { allowDangerousHtml: true });
