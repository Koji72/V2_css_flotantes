...
const templates_1 = require("../types/templates");
const panelStyleThemes_json_1 = __importDefault(require("../data/panelStyleThemes.json"));
// Type assertion for the imported JSON
const styleThemesData = panelStyleThemes_json_1.default;
class TemplateManager {
    // Singleton pattern
    constructor() {
        this.currentTemplate = null;
        this.templates = new Map();
        this.currentTemplateId = 'purple_neon_grid';
    ...
    initializeTemplates() {
        templates_1.templates.forEach(template => {
    ...
    getAvailableTemplates() {
        ...
        const templateFiles = import.meta.glob('/public/templates/*.css', { eager: false });
     ...
     */
    getVisualStylesForTemplate(templateId) {
        ...
        const availableStyles = styleThemesData.styleDetails.filter(style => combinedStyleIds.has(style.id));
